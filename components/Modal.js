...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // get download url from firebase storage and update original post with img
      ...
      >
        <div className=" flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className=" fixed inset-0 bg-black bg-opacity-[0.75] transition-opacity" />
          </Transition.Child>
                ...
                {selectedFile ? (
                  <div className=" items-center justify-center grid">
                    <img
                      src={selectedFile}
                      alt="Uploaded Pic"
                      className=" h-[250px] mx-auto object-contain cursor-pointer"
                    />
                    <div className="flex">
                      <button
                        type="button"
                        className=" px-4 py-2 bg-blue-500 rounded-md mx-auto text-white text-xs mt-4"
                      ...
                      <button
                        type="button"
                        className=" px-4 py-2 bg-red-500 rounded-md mx-auto text-white text-xs mt-4"
